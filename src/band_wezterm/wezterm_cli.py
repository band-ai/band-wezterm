...
def format_focus_sequence() -> str:
    ...
    # Local import keeps wezterm_cli free of osc's allowlist for display fields.
    from band_wezterm.osc import OSC_PREFIX, OSC_SUFFIX, encode_payload

    return f"{OSC_PREFIX}band.focus={encode_payload('1')}{OSC_SUFFIX}"
